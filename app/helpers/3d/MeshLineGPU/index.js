...
const vsShader = glsl.file('./shaders/MeshLineGPU.vs')
const fsShader = glsl.file('./shaders/MeshLineGPU.fs')
...
export default class MeshLineGPU extends THREE.Mesh {
  constructor({
    ...
    const depthMaterial = new THREE.ShaderMaterial({
      vertexShader: depthVerstexShader || glsl.file('./shaders/MeshLineGPUDepth.vs'),
      fragmentShader: depthFragmentShader || glsl.file('./shaders/MeshLineGPUDepth.fs'),
    ...
    this._simulationMaterial = new THREE.ShaderMaterial({
      ...
      vertexShader: glsl.file("./shaders/simulation.vs"),
      fragmentShader: glsl.file("./shaders/simulation.fs"),
    });
